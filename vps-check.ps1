...
$checkCommands = @"
echo 'Current directory and git status:'; cd $APP_DIR; pwd; git log -1 --oneline; git status; echo ''; echo 'PM2 process status:'; pm2 status; echo ''; echo 'Port 3000 status:'; netstat -tlnp | grep :3000; echo ''; echo 'System resources:'; free -h; df -h /var/www; echo ''; echo 'Recent PM2 logs:'; pm2 logs glowfm-web --lines 10
"@

  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-glow-midnight/80 backdrop-blur-xl transition-colors">
      <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-4">
        <a
          className="flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white shadow-soft"
        ...
        <div className="flex flex-col">
          <span className="text-xs font-semibold uppercase tracking-[0.4em] text-glow-sky/80">Glow 99.1 FM</span>
